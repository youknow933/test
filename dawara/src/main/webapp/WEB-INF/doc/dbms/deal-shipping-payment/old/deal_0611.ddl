...
COMMENT ON COLUMN mycard.dealsortno is '거래수단번호';
...
COMMENT ON TABLE cash is '캐시적립';
COMMENT ON COLUMN cash.cashno is '캐시번호';
COMMENT ON COLUMN cash.mycash is '현재캐시';
COMMENT ON COLUMN cash.savecash is '적립캐시';
COMMENT ON COLUMN cash.usecash is '사용캐시';
COMMENT ON COLUMN cash.savedate is '적립날짜';
COMMENT ON COLUMN cash.usedate is '사용날짜';
COMMENT ON COLUMN cash.mywalletno is '지갑번호';
COMMENT ON COLUMN cash.dealno is '거래번호';

...
<%--       <a href="./list_by_mem_no.do?mem_no=${param.mem_no }">택배거래 목록</a> --%>
      <a href="./searchList_by_mem_no.do?mem_no=${param.mem_no }">택배거래 목록</a>
      <!-- 검색 -->
  ...
  <form name="searchList" id="searchList" method ='GET' action="./searchList_by_mem_no.do" >
    ...
    <div class="searchbox">
      <div class="bloc">
        <span class="tit">
          ...
          <label><input type="radio" id="ship_addr" name="searchItem" value="배송지">배송지</label> 
          <label><input type="radio" id="ship_rname" name="searchItem" value="받는사람">받는사람</label>
          <label><input type="radio" id="ship_rtel" name="searchItem" value="연락처">연락처</label>
          <label><input type="radio" id="ship_date" name="searchItem" value="등록일">등록일</label>
          <label><input type="radio" id="ship_check" name="searchItem" value="배송여부">배송여부</label>
        </span> 
      </div>
      <div class="bloc right_area">
        ...
        <button type="button" onclick="location.href='./searchList_by_mem_no.do?mem_no=${param.mem_no}'">전체 보기</button>
      </div>  
    </div>
  </form>
  ...
  <tbody>
    <c:forEach var="ShippingVO" items="${searchList }">
      <TR>
...
<%--           <A href="./read.do?ship_no=${ShippingVO.ship_no }">${ShippingVO.ship_address }</A> --%>
        </TD>

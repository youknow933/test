...
<script type="text/javascript">
  ...
  function fileCheck(){
    if($('#mem_pic').val() != ""){
      var ext = $('#mem_pic').val().split('.').pop().toLowerCase();
      ...
      var size =  document.getElementById("mem_pic").files[0].size;
...
<body>
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' 
              onsubmit="return send();" class="form-horizontal" style='padding: 10px 30%;'>
...
<!-- ----- DAUM 우편번호 API 종료----- -->
    ...
    <div class="form-group">
      <label for="mem_pic" class="col-md-2 control-label">회원사진</label>    
      <div class="col-md-10">
        <table>
          <tr>
            <td style='border:1px solid #44444455;'><input type='file' id='mem_pic' name='mem_pic' accept="image/gif, image/jpeg, image/png" style='width: 100%; border:black;'></td>

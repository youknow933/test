...
<DIV class='content'>     
  ...
  <div class='menu_line'></div>
    <FORM name='frm' method='POST' action='./update.do'
      ...
      <input type='hidden' name='pr_no' id='pr_no' value='${productVO.pr_no }'>
...
<%--       <input type='hidden' name='mem_no' id='mem_no' value='${sessionScope.mem_no }'> --%>
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='pr_title' id='pr_title' value='${productVO.pr_title }' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="pr_contents" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='pr_contents' id='pr_contents'  rows='10'>${productVO.pr_contents }</textarea>
        </div>
      </div>
       ...
       <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='pr_buyyear' id='pr_buyyear' value='${productVO.pr_buyyear.substring(0, 10)}' style='width:20%'>
       ...
       <div class="form-group">   
        ...
        <select name = 'pr_state' id='pr_state' style='width:10%'>
          <c:choose>
            <c:when test="${productVO.pr_state == '중고' }">
        ...
        <select name = 'pr_transaction' id='pr_transaction'style='width:10%'>
          <c:choose>
            <c:when test="${productVO.pr_transaction == '직거래' }">
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='pr_local' id='pr_local' value='${productVO.pr_local }' style='width:10%'>
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='pr_buyprice' id='pr_buyprice' value=${productVO.pr_buyprice } style='width:10%'>
        </div>
        </div>
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='pr_price' id='pr_price' value=${productVO.pr_price } style='width:10%'>
        </div>
        </div>
     ...
     <div id='file1Panel' class="form-group">
          ...
          <c:if test="${file_list.size() > 0 }">
              <DIV>
                <c:forEach var ="fileVO"  items="${file_list }">
                  <A href="javascript: panel_img('${fileVO.pr_file }')"><IMG src='./storage/${fileVO.pr_thumb }' style='margin-top: 2px;'></A>
                </c:forEach>
              </DIV>
            </c:if>
        </div>
      ...
      <div class="form-group">   
        <label for="pr_filesMF" class="col-md-1 control-label">파일</label>
        <div class="col-md-11">
      ...
      <DIV style='text-align: right;'>
        ...
        <button type="button" onclick="location.href='./list.do?gory_no=${param.gory_no }&pr_title=${param.pr_title}&nowPage=${param.nowPage}'">취소[목록]</button>
        </DIV>
    </FORM>
  </DIV>

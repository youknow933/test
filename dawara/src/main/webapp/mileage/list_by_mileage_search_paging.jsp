...
<script type="text/javascript">
  ...
  function deleteOne(mileage_no) {
   ...
   /*  $('#grp_no', frm_delete).val(${categrpVO.grp_no }); // Javascript + EL */
    ...
    var panel = ''; 
    panel += "<DIV id='panel' class='popup1' style='height: 150px; line-height: 30px; top: 300px;'>";
...
<DIV class='content' style='width: 100%;'>
 ...
 <form name='frm' id='frm' method="get" action="./list_by_mileage_search_paging.do">
  ...
  <ASIDE style='float: right;'>
   ...
   <select name='mileage_search' id='mileage_search'>
    <option value='mileage_search_all' selected="selected">전체</option>
        <option value='mileage_search_mem_no'>회원번호</option>
        <option value='mileage_search_char_m'>충전금액</option>
        <option value='mileage_search_cway'>충전방법</option>
    </select> 
...
<!--        <label class='label' >마일리지 충전방법</label> -->
<!--         <select name='cway' id='cway'> -->
<!--           <option value='카드' selected="selected">카드</option>      -->
<!--           <option value='계좌이체'>계좌이체</option> -->
<!--           <option value='무통장입금'>무통장입금</option> -->

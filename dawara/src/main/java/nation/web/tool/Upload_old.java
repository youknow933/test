 ...
 */ 
public class Upload_old extends HttpServletRequestWrapper { 
     ...
     */ 
    public Upload_old(HttpServletRequest request)  
    throws FileUploadException{ 
     ...
     */ 
    public void addTo() { 
        super.setAttribute(Upload_old.class.getName(), this); 
    } 
    ...
    public Upload_old  
        ...
        return (Upload_old) 
            request.getAttribute(Upload_old.class.getName()); 
    } 
